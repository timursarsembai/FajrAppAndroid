    ...
    Column(
                ...
                modifier = Modifier.size(48.dp)
                 ...
                 Box(modifier = Modifier.fillMaxSize().clickable { onBack() }, contentAlignment = Alignment.Center) {
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.settings_title), // Back description
                        tint = Color.White
                    )
                 }
            }
        ...
        Column(
            ...
            SettingsItem(
                ...
                subtitle = if (uiState.selectedLanguage.code == "ru") "Москва, Россия" else "Moscow, Russia", // Need to bind to VM actually
                hazeState = hazeState
            )
            SettingsItem(
